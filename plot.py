...
class RadarPlot:
    ...
    def __init__(self, data, start_time=None):
        ...
        if not self._start_time:
            self._start_time = datetime.now() - relativedelta.relativedelta(hour=6)
    ...
    def make_plot(self):
        ...
        with plt.style.context('dark_background'):  # Activate dark theme
            ...
            for i in range(num_plots):
                ...
                for j, dc in enumerate(self.site_names[i]):
                    # Pad shorter arrays with zeros to match max_length
